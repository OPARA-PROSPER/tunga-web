      ...
      <section className="DevProfile">
        <PageScroll pages={pages}>
          <div id="Profile" className="DevProfile__profile">
            <div className="DevProfile__header" style={{ backgroundImage: `url(${SearchFormBg})` }}>
              ...
              <div className="DevProfile__bg-mask"></div>
            </div>
            <div className="">{talent.display_name && <Profile talent={talent} />}</div>
          </div>
