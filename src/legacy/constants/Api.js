...
export const LEGACY_PROGRESS_REPORT_STATUS_ON_SCHEDULE = 1;
export const LEGACY_PROGRESS_REPORT_STATUS_BEHIND = 2;
export const LEGACY_PROGRESS_REPORT_STATUS_STUCK = 3;

export const LEGACY_PROGRESS_REPORT_STATUS_BEHIND_BUT_PROGRESSING = 4;
export const LEGACY_PROGRESS_REPORT_STATUS_BEHIND_AND_STUCK = 5;

export const LEGACY_PROGRESS_REPORT_STATUS_CHOICES = [
    {id: LEGACY_PROGRESS_REPORT_STATUS_ON_SCHEDULE, name: 'On schedule'},
    {id: LEGACY_PROGRESS_REPORT_STATUS_BEHIND_AND_STUCK, name: 'Behind and Stuck'},
    {
        id: LEGACY_PROGRESS_REPORT_STATUS_BEHIND_BUT_PROGRESSING,
