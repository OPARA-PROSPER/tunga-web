export const TESTIMONIALS = [
    {
        ...
        company: 'Kukua',
        position: 'Founder',
        image: require('../../assets/images/testimonials/ollie.png').default,
        message:
    ...
    },
    {
        ...
        position: 'Director',
        image: require('../../assets/images/testimonials/Thami.png').default,
        message:
    ...
    },
    {
        ...
        company: 'Mango Tree',
        position: 'Director',
        image: require('../../assets/images/testimonials/ineke.png').default,
        message:
    ...
    },
    {
        ...
        image: require('../../assets/images/testimonials/Annemiek.png').default,
        message:
    ...
    },
    {
        ...
        company: 'CWZ',
        position: 'Director',
        image: require('../../assets/images/testimonials/Kasper.png').default,
        message:
...
export function getClientTestimonials(max = 0) {
    ...
    TESTIMONIALS.map(item => {
        if (item.wizard) {
            clientTestimonials.push(item);
        }
    });
    return clientTestimonials.slice(0, max ? max : TESTIMONIALS.length);
}
